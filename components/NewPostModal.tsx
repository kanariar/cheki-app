            ...
            <div className="flex-1 grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 overflow-y-auto px-4 sm:px-8 pb-4">
              ...
              <div className="md:col-span-7 flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-1.5 flex-1">
                  ...
                  <textarea placeholder="メモを自由に記入..." value={comment} onChange={(e) => setComment(e.target.value)} className="w-full border border-gray-300 p-3 rounded-none text-sm text-gray-900 focus:ring-2 focus:ring-inset focus:ring-slate-800 bg-white flex-1 min-h-[100px]" />
                </div>
              </div>
            </div>
